...
# QEMU_BIN=~/qemu-patched/bin/qemu-system-i386 # For real mode debugging
QEMU_BIN=qemu-system-i386                      # For protected mode debuggin (not patched, meaning gdb will be in 32 bits)
